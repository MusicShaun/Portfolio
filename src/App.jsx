...
import BananaShop from './components/iFrames/BananaShop';
import TodoList from './components/iFrames/TodoList';
import Contact from './features/contact/Contact';
import Mastering from './components/iFrames/Mastering';
import Quiz from './components/iFrames/Quiz';
import Columns from './components/iFrames/Columns';
import Loader from './components/Loader';
import React, { useState , useEffect } from 'react'; 
import { device } from './helpers/screenSizes';
import StyledBurger from './components/Hamburger';
