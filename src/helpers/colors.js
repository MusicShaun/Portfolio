export const colorBlue = '#659DBD';
export const colorSand =  '#FBEEC1';
export const colorWhite = 'hsl(60, 28%, 95%)';
export const colorCream = 'hsl(60, 28%, 95%)';
export const colorBlack = 'hsl(40, 3%, 17%)';
